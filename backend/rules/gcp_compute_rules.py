...
def evaluate_instance(instance):
    ...
    security = instance.get(
        "security",
        {}
    )

    relationships = instance.get(
        "relationships",
        {}
    )
    ...
    if security.get(
        ...
        findings.append(
            create_finding(
                ...
                description=(
                    f"{instance['name']} has an external public IP address."
                ),
                recommendation=(
                    "Remove the public IP or place the VM behind Cloud NAT or a Load Balancer."
                ),
        ...
        if (
            ...
            findings.append(
                create_finding(
                    ...
                    description=(
                        f"{instance['name']} is using the default Compute Engine service account."
                    ),
                    recommendation=(
