    ...
    if "compute@developer.gserviceaccount.com" in email:
        ...
        findings.append(
            create_finding(
                ...
                description=(
                    f"{email} is the default Compute Engine service account."
                ),
                recommendation=(
                    "Create a dedicated least-privilege service account with least-privilege permissions instead of using the default Compute Engine service account."
                ),
